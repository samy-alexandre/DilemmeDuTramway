...
window.CATEGORIES = {
  ...
  lever: {
    ...
    variants: {
      ...
      tyran: {
        name: "Le tyran déchu", tagline: "Le bourreau improvisé", intensity: "moral",
        intro: "Sur la voie principale, cinq inconnus. Sur la voie déviée, un dictateur déchu reconnu coupable du génocide de millions de personnes.",
        labels: { act: "Tirer le levier", wait: "Ne rien faire" },
        outcomes: {
          act: { tag: "Rétribution + utilité", title: "Le calcul devient évident",
            text: "Bilan écrasant : cinq sauvés + un génocidaire éliminé. Les théories rétributivistes acceptent ce calcul. Mais agir comme bourreau sans procès reste hors de l'État de droit.",
            deaths: 1, saved: 5,
            traits: { utilitarian: 2, authoritarian: 1, rebellious: 1 },
            contradictionTags: ["sacrifice_one_for_many", "moral_desert", "active_intervention"] },
          wait: { tag: "Abolitionnisme strict", title: "Personne ne mérite la mort",
            text: "Vous refusez de juger qui doit vivre. Même un criminel garde des droits (Beccaria, Hugo). Mais cinq innocents meurent alors qu'un seul coupable suffisait.",
            deaths: 5, saved: 0,
            traits: { protective: 2, logical: 1, rebellious: 1 },
            contradictionTags: ["preserve_one", "rights_first", "no_personal_judgment"] }
        }
      },
      chercheuse: {
  ...
  bridge: {
    ...
    variants: {
      ...
      criminel: {
        name: "Le meurtrier reconnu", tagline: "Pousser un coupable", intensity: "moral",
        intro: "L'homme corpulent à vos côtés est un meurtrier en cavale identifié sur l'avis de recherche. Le pousser sauvera les cinq.",
        labels: { act: "Pousser le meurtrier", wait: "Ne rien faire" },
        outcomes: {
          act: { tag: "Justice expéditive", title: "Utilité + désert",
            text: "Vous combinez arithmétique et rétribution. Plus facile que le pont standard — mais agir comme bourreau sans procès est la définition de la justice expéditive.",
            deaths: 1, saved: 5,
            traits: { utilitarian: 2, authoritarian: 2, rebellious: 1 },
            contradictionTags: ["sacrifice_one_for_many", "moral_desert", "vigilante_justice"] },
          wait: { tag: "Présomption de droits", title: "Pas de peine sans procès",
            text: "Même un criminel garde ses droits procéduraux. Mais cinq meurent pour votre respect des formes.",
            deaths: 5, saved: 0,
            traits: { logical: 2, protective: 1 },
  ...
  guerre: {
    ...
    variants: {
      interrogation: {
        name: "L'interrogatoire", tagline: "Parler ou tenir", intensity: "dark",
        intro: "Résistant capturé. Sous la torture, vous finirez par parler. Si vous parlez maintenant, vos cinq camarades ont 24 h pour fuir.",
        labels: { act: "Parler tout de suite", wait: "Tenir le plus longtemps possible" },
        shortLabels: { act: "Parler\ntôt = 5 fuient", wait: "Tenir\n= pari risqué" },
        outcomes: {
          act: { tag: "Limites humaines", title: "Tout le monde finit par parler",
            text: "La torture a un taux de réussite documenté de près de cent pour cent. Mieux vaut parler maintenant et laisser une chance aux camarades. Mais vous porterez le poids d'avoir « collaboré ».",
            traits: { logical: 3, protective: 2, conformist: 1 },
            contradictionTags: ["pragmatic", "save_ingroup", "self_compromise"] },
          wait: { tag: "Vertu héroïque", title: "Chaque heure peut compter",
            text: "Vous tentez de protéger le réseau plus longtemps. Vertu héroïque. Mais pari risqué : si vous parlez plus tard, l'effet de surprise est perdu.",
            traits: { courage: 3, loyal: 3, emotional: 2 },
            contradictionTags: ["heroic_stance", "ingroup_loyalty", "self_sacrifice"] }
        }
      },
      deserter: {
